      ...
      <Slides slides={slides} count={5} step={page} setStep={setPage}>
        <Container flexDirection="column" gap={8}>
          ...
          <Container width={204}>
            ...
            {component === 1 && (
              <Span>
                The Laser Scanning Unit is comprised of a laser source, a scanner, and an optical
                system. The laser provides energy to melt and fuse the powder, the scanner deflects
                and directs the laser beam, and the optical system focuses the beam onto the powder
                bed.
              </Span>
            )}
            {component === 2 && (
              <Span>
                The Recoating Unit pushes the powder from the powder reservoir onto the Build
                Platform and ensures the formation of an even powder layer.
              </Span>
            )}
            {component === 3 && (
              <Span>
                The Recirculating Filter System ensures a clean build environment. It channels a gas
                flow over the build platform to remove the process byproducts like fumes and smatter
                generated during the laser melting. Additionally, it also helps stabilise the
                thermal environment.
              </Span>
            )}
          </Container>
        ...
        <Container flexDirection="column" gap={8}>
          <Span fontWeight={700} width={200}>
            Start Printing and observe the layer-by-layer build-up of the print job, which is an
            arrangement of 18 parts!
          </Span>
          <RoundedButton outline={component === 1} onClick={() => play()}>
            Start Printing
          </RoundedButton>
          <Span color="#C00000" width={200} marginTop={98}>
            Note: The process is compacted to avoid extended exposure to the VR environment.
          </Span>
        </Container>
        <Container flexDirection="column" gap={8}>
          ...
          <Container marginTop={8} justifyContent="space-between">
            ...
            <Information flexDirection="column" height={140} positionTop={-142}>
              <Span paddingY={4} fontSize={6.5}>
                After printing, you cannot see the part yet; the Build Platform has the powder bed
                with the part in it.
              </Span>
              <Span paddingY={4} fontSize={6.5}>
                The first step is to remove the Build Platform from the printer. The loose powder is
                cleared using a brush.
              </Span>

              <Span paddingY={4} fontSize={6.5}>
                The parts are attached to the Build Platform. They are separated from the platform
                using Electrical Discharge Machining (EDM) wire cutting.
              </Span>
              <Span paddingY={4} fontSize={6.5}>
                The final parts obtained then undergo a heat treatment as recommended by EOS for
                Aluminium AlSi10Mg. The parts are solution annealed for 30 minutes at 530 °C and
                then water quenched. It is then followed by artificial aging for 360 minutes at 165
                °C, after which the parts are air cooled.
              </Span>
            </Information>
          </Container>
        </Container>
